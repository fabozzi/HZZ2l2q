...
if doJetPileUpCorrection:
    ...
    # avoid double calculation of rho (not for 4_4) #
...
if runAK5NoPUSub:
    ...
    # disable embedding of PFparticles in PAT jets to avoid duplication of the PFparticles collection (not for 5_2)
